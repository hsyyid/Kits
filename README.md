...
1. `git clone git@github.com:hsyyid/Kits.git`
2. `cd Kits`
...
In order to build Kits you simply need to run the `gradle` command.
You can find the compiled JAR file in `./build/libs` labeled similarly to 'Kits-x.x.jar'.

[Source]: https://github.com/hsyyid/Kits
[Wiki]: https://github.com/hsyyid/Kits/wiki
